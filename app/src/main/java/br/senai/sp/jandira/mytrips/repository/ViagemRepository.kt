...
class ViagemRepository {
    // Quando chamar viagemreposity criar uma lista de viagem


    // Retornar uma lista de viagens    <> - diamond  (dentro dele o tipo de colecoes)
    @Composable
    fun listarTodasAsViagens(): List<Viagem> {
        ...
        // Como nao tenho ainda a imagem coloca null
        saoPaulo.imagem = painterResource(id = R.drawable.sp)
        ...
        // Retornar o objeto, e dentro desse londres temos todos os dados
